...
(() => {
  ...
  const dict = {
    uz: {
      ...
      views: "Ko'rish",
      none_yet: 'Hali yo‘q',
      report_overview: 'Umumiy ko‘rinish',
      report_composition: 'Tizim tarkibi',
      report_market_compare: 'Bozorlar solishtiruvi',
      report_top_views: 'Eng ko‘p ko‘rilgan do‘konlar',
      chart_shops: "Do‘konlar",
      chart_products: 'Mahsulotlar',
      chart_views: "Ko‘rishlar",
      kpi_markets: 'Bozorlar',
      kpi_shops: "Do‘konlar",
      kpi_products: 'Mahsulotlar',
      kpi_owners: 'Egalari',
      kpi_promo: 'Aksiyalar',
      table_details: 'Batafsil jadval',
      no_chart_data: 'Grafik uchun ma’lumot yo‘q',
    ...
    ru: {
      ...
      views: 'Просмотры',
      none_yet: 'Пока нет',
      report_overview: 'Обзор',
      report_composition: 'Состав системы',
      report_market_compare: 'Сравнение базаров',
      report_top_views: 'Самые просматриваемые магазины',
      chart_shops: 'Магазины',
      chart_products: 'Товары',
      chart_views: 'Просмотры',
      kpi_markets: 'Базары',
      kpi_shops: 'Магазины',
      kpi_products: 'Товары',
      kpi_owners: 'Владельцы',
      kpi_promo: 'Акции',
      table_details: 'Подробная таблица',
